module github.com/seb-schulz/cert-manager-webhook-hostsharing
...
replace github.com/cert-manager/cert-manager => github.com/cert-manager/cert-manager v1.11.5
